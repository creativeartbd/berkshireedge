...
<div class="site" id="page">
	<div class="header">
	<!-- ******************* The Navbar Area ******************* -->
		<div id="wrapper-navbar" itemscope itemtype="http://schema.org/WebSite" style="margin-bottom: 30px;">
					...
					<div class="row">
						<div class="col-9 col-sm-6 col-md-6">
							<div class="header-site-logo">
								<div class="sticky-logo" style="display: block;">
		...
		<?php if ( is_page( 'wedding-directory' ) ) {
			if ( is_active_sidebar( 'wedding-header-archive-single' ) ) {
				echo '<div class="container">';
				dynamic_sidebar( 'wedding-header-archive-single' );
				echo '</div>';
			}
		} ?>
